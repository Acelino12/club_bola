...
public class clubdata {
    private static String[] clubname={
            ...
            "Newcastle United", "Sheffield United", "Southampton", "Tottenham Hotspur",
            "West Bromwich Albion", "West Ham United FC", "Wolverhampton Wanderers"
    };

    private static String[] ditail={
    ...
    private static int[] clubimage={
            R.drawable.arsenal, R.drawable.aston, R.drawable.brighton,
            R.drawable.burnley, R.drawable.chelsea, R.drawable.crystal,
            R.drawable.everton, R.drawable.fulham, R.drawable.leeds,
            R.drawable.leicester, R.drawable.liverpool, R.drawable.mancity,
            R.drawable.manutd, R.drawable.newcastle, R.drawable.sheffield,
            R.drawable.southampton, R.drawable.tottenham, R.drawable.wba,
            R.drawable.westham, R.drawable.wolverhampton
    };
    ...
    static ArrayList<club> getListData(){
        ...
        for (int i = 0; i < clubname.length; i++){
            club club = new club();
            club.setName(clubname[i]);
            club.setDetail(ditail[i]);
            club.setPhoto(clubimage[i]);
            list.add(club);
        }
        return list;
    }
